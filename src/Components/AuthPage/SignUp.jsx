...
export default function SignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      const response = await fetch("https://mentor-app-api.onrender.com/accounts/signup/", {
        method: "POST",
        headers: {
  ...
  return (
    ...
    <div className="bg-white p-10 rounded-2xl shadow-lg w-full max-w-6xl flex flex-row items-center">
      {/* Left Section - Logo */}
      <div className="w-1/2 flex justify-center">
        <img src={SignUpLogo} alt="Logo" className="w-[100%] h-auto" />
      </div>

      {/* Right Section - Sign Up Form */}
      <div className="w-1/2 p-5">
        <h2 className="text-4xl font-bold text-[#2946ae] text-center mb-6">Sign Up</h2>
        <form onSubmit={handleSignUp}>
          {/* First & Last Name */}
          <div className="flex gap-4">
            <div className="mb-5 w-1/2">
              <label className="block text-xl text-[#333333] font-semibold mb-2">First Name</label>
              <input
                type="text"
                name="firstName"
            ...
            <div className="mb-5 w-1/2">
              <label className="block text-xl text-[#333333] font-semibold mb-2">Last Name</label>
              <input
                type="text"
                name="lastName"
          ...
          {/* Email Input */}
          <div className="mb-5">
            <label className="block text-xl text-[#333333] font-semibold mb-2">Email</label>
          ...
          {/* Role Selection */}
          <div className="mb-5">
            <label className="block text-xl text-[#333333] font-semibold mb-2">Role</label>
            <div className="flex items-center border border-gray-500 rounded-full bg-gray-100 px-4 py-3">
          ...
          <div className="flex gap-4">
            <div className="mb-5 w-1/2">
              <label className="block text-xl text-[#333333] font-semibold mb-2">Create Password</label>
              <div className="flex items-center border border-gray-500 rounded-full bg-gray-100 px-4 py-3">
            ...
            <div className="mb-5 w-1/2">
              <label className="block text-xl text-[#333333] font-semibold mb-2">Confirm Password</label>
              <div className="flex items-center border border-gray-500 rounded-full bg-gray-100 px-4 py-3">
                <RiLockPasswordFill className="text-gray-500 text-xl" />
                <input
                  type="password"
