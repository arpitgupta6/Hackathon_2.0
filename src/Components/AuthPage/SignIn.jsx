...
export default function SignIn() {
  ...
  return (
    <div className="h-screen flex items-center justify-center px-4 bg-[#A3C4FD]">
      <div className="bg-white p-10 rounded-2xl shadow-lg w-full max-w-5xl flex flex-row items-center">
        {/* Left Section - Logo */}
        <div className="w-1/2 flex justify-center">
          <img src={SignInLogo} alt="Logo" className="w-[100%] h-[50%] mb-4" />
        </div>
        ...
        <div className="w-1/2 p-5">
          ...
          <form onSubmit={handleSignIn}>
            ...
            <div className="text-right mb-5">
              <span
                className="text-blue-600 text-lg font-bold cursor-pointer hover:underline"
